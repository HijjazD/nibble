  ...
  const visitDetails = [
    {
      icon: MapPin,
      title: "Location",
      content: "41, GF, Jalan SS 18/6, SS18, 47500, Subang Jaya, Selangor.",
      color: "red",
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Clock,
      title: "Hours",
      content: "Tue – Sat, 9:30 AM – 6:30 PM",
      color: "amber",
    },
  ];
  ...
  return (
    <section id="contact" className="contact-section">
      ...
      <div className="contact-header">
        <div className="badge">LEVEL UP YOUR VISIT</div>
        ...
        <p>Ready to level up your coffee game? ☕🎮</p>
      </div>
      ...
      <div className="contact-grid">
        ...
        <div>
          <div className="visit-card">
            ...
            {visitDetails.map((d, i) => (
              <div key={i} className="visit-item">
                <div className={`icon-box ${d.color}`}>
                  <d.icon />
                </div>
                <div>
...
//     <section
//       id="contact"
//       className="relative w-full min-h-screen py-20 px-5 md:px-10 bg-[#fff4dc] overflow-hidden"
//     >
...
//               <p className="text-white font-bold text-sm tracking-widest font-masa">
//                 LEVEL UP YOUR VISIT
//               </p>
//             </div>
//           </div>
...
//           <h2
//             className="text-5xl md:text-7xl mb-6 text-amber-900 font-bold relative inline-block"
//             style={{
...
//               <div className="absolute top-0 left-0 w-full h-2 bg-linear-to-r from-red-500 via-amber-500 to-green-500"></div>
...
//                   <div
//                     key={index}
//                     className="group bg-linear-to-r from-amber-50 to-white rounded-xl p-4 border-2 border-amber-200 hover:border-amber-600 transition-all duration-300 hover:shadow-lg"
//                   >
//                     <div className="flex items-start gap-4">
//                       <div
//                         className={`${detail.color} p-3 rounded-lg border-2 border-gray-900 shadow-md shrink-0`}
//                       >
...
//                   <div
//                     key={i}
//                     className="w-4 h-4 bg-red-500 transform rotate-45"
//                   ></div>
//                 ))}
//               </div>
//             </div>
...
//             {/* Achievement Badge */}
//             <div className="bg-linear-to-r from-amber-600 to-amber-700 rounded-2xl p-6 border-4 border-amber-900 shadow-xl text-white">
...
//                   <div className="h-full bg-linear-to-r from-green-500 to-green-600 w-full"></div>
//                 </div>
//                 <span
