...
function Blog() {
  const posts = [
    {
      image:
        "https://media.freemalaysiatoday.com/wp-content/uploads/2025/03/7cc0030d-nibbles-cafe-lifestyle-emel-pic-270325-1.webp",
      title: "Brewing Success Through Entrepreneurial Studies",
      excerpt:
        "Fresh out of Taylor's University, Wan Muhammad Wan Sa'adi knew with certainty that he hadn't only earned a degree – he had brewed up his entrepreneurial dream with Nibbles Café.",
      date: "March 28, 2025",
      readTime: "5 min read",
      category: "Our Story",
    ...
    <section id="blog" className="blog-section">
      ...
      <div className="blog-container">
        ...
        <div className="blog-header">
          ...
          <h2>Café Chronicles</h2>
          <div className="divider"></div>
          <p>Stories, updates & the heart behind every cup at Nibbles</p>
        </div>
        ...
        <div className="coming-soon">
          <Coffee />
          <p className="title">More stories brewing...</p>
          <p>Stay tuned for more updates from Nibbles!</p>
        </div>
      </div>
...
//           </div>
//           <h2
//             className="text-5xl md:text-7xl mb-6 text-amber-800"
...
//                   </div>
//                   {/* Overlay gradient */}
//                   <div className="absolute inset-0 bg-linear-to-r from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
//                 </div>
